...
import numpy as np
from PyQt6.QtCore import pyqtProperty, QLineF, QObject, QPointF, QPropertyAnimation, QRectF, Qt
from PyQt6.QtGui import QBrush, QColor, QPen, QPainterPath, QPolygonF, QRadialGradient, QTransform
