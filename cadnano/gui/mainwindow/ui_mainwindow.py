...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.main_toolbar.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        ...
        self.filter_view_toolbar.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.filter_view_toolbar.setMovable(True)
        self.filter_view_toolbar.setAllowedAreas(QtCore.Qt.ToolBarArea.LeftToolBarArea|QtCore.Qt.ToolBarArea.RightToolBarArea|QtCore.Qt.ToolBarArea.TopToolBarArea)
        self.filter_view_toolbar.setIconSize(QtCore.QSize(20, 20))
        self.filter_view_toolbar.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly)
        self.filter_view_toolbar.setFloatable(False)
        self.filter_view_toolbar.setObjectName("filter_view_toolbar")
        MainWindow.addToolBar(QtCore.Qt.ToolBarArea.TopToolBarArea, self.filter_view_toolbar)
        ...
        self.slice_graphics_view.setFocusPolicy(QtCore.Qt.FocusPolicy.WheelFocus)
        self.slice_graphics_view.setStyleSheet("QGraphicsView { background-color: #f6f6f6; }")
        self.slice_graphics_view.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.slice_graphics_view.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.slice_graphics_view.setLineWidth(0)
        self.slice_graphics_view.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.slice_graphics_view.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.slice_graphics_view.setRenderHints(QtGui.QPainter.RenderHint.Antialiasing|QtGui.QPainter.RenderHint.TextAntialiasing)
        self.slice_graphics_view.setDragMode(QtWidgets.QGraphicsView.DragMode.NoDrag)
        self.slice_graphics_view.setTransformationAnchor(QtWidgets.QGraphicsView.ViewportAnchor.AnchorUnderMouse)
        self.slice_graphics_view.setResizeAnchor(QtWidgets.QGraphicsView.ViewportAnchor.AnchorUnderMouse)
        ...
        self.grid_graphics_view.setFocusPolicy(QtCore.Qt.FocusPolicy.WheelFocus)
        self.grid_graphics_view.setStyleSheet("QGraphicsView { background-color: #f6f6f6; }")
        self.grid_graphics_view.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.grid_graphics_view.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.grid_graphics_view.setLineWidth(0)
        self.grid_graphics_view.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.grid_graphics_view.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.grid_graphics_view.setRenderHints(QtGui.QPainter.RenderHint.Antialiasing|QtGui.QPainter.RenderHint.TextAntialiasing)
        self.grid_graphics_view.setDragMode(QtWidgets.QGraphicsView.DragMode.NoDrag)
        self.grid_graphics_view.setTransformationAnchor(QtWidgets.QGraphicsView.ViewportAnchor.AnchorUnderMouse)
        self.grid_graphics_view.setResizeAnchor(QtWidgets.QGraphicsView.ViewportAnchor.AnchorUnderMouse)
        ...
        self.path_graphics_view.setFocusPolicy(QtCore.Qt.FocusPolicy.WheelFocus)
        self.path_graphics_view.setStyleSheet("QGraphicsView { background-color: #f6f6f6; }")
        self.path_graphics_view.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.path_graphics_view.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.path_graphics_view.setLineWidth(0)
        self.path_graphics_view.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.path_graphics_view.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.path_graphics_view.setRenderHints(QtGui.QPainter.RenderHint.Antialiasing|QtGui.QPainter.RenderHint.TextAntialiasing)
        self.path_graphics_view.setTransformationAnchor(QtWidgets.QGraphicsView.ViewportAnchor.AnchorUnderMouse)
        ...
        self.outliner_property_splitter.setOrientation(QtCore.Qt.Orientation.Vertical)
        ...
        self.outliner_widget.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        self.outliner_widget.setStyleSheet("OutlinerTreeWidget { background-color: #f6f6f6; }\n"
"\n"
"")
        self.outliner_widget.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.outliner_widget.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.EditKeyPressed|QtWidgets.QAbstractItemView.EditTrigger.SelectedClicked)
        ...
        self.property_widget.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        self.property_widget.setStyleSheet("QTreeView {alternate-background-color:#f0f0f0;}")
        self.property_widget.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.property_widget.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        self.property_widget.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.DoubleClicked|QtWidgets.QAbstractItemView.EditTrigger.EditKeyPressed|QtWidgets.QAbstractItemView.EditTrigger.SelectedClicked)
        ...
        self.property_buttonbox.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.property_buttonbox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Apply|QtWidgets.QDialogButtonBox.StandardButton.Cancel)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/filetools/new"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_new.setIcon(icon)
        self.action_new.setObjectName("action_new")
        self.action_open = QtGui.QAction(MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/filetools/open"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/filetools/save"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_save.setIcon(icon2)
        self.action_save.setObjectName("action_save")
        self.action_save_as = QtGui.QAction(MainWindow)
        self.action_save_as.setIcon(icon2)
        self.action_save_as.setObjectName("action_save_as")
        self.action_save_a_copy = QtGui.QAction(MainWindow)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/filetools/svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_SVG.setIcon(icon3)
        self.action_SVG.setObjectName("action_SVG")
        self.action_X3D = QtGui.QAction(MainWindow)
        ...
        self.action_new_honeycomb_part = QtGui.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/parttools/new-honeycomb"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_new_honeycomb_part.setIcon(icon4)
        self.action_new_honeycomb_part.setObjectName("action_new_honeycomb_part")
        self.action_new_dna_part = QtGui.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/parttools/new-square"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_new_dna_part.setIcon(icon5)
        self.action_new_dna_part.setObjectName("action_new_dna_part")
        self.action_path_break = QtGui.QAction(MainWindow)
        self.action_path_break.setCheckable(True)
        self.action_path_break.setChecked(False)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/pathtools/break"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_path_break.setIcon(icon6)
        self.action_path_break.setObjectName("action_path_break")
        self.action_path_select = QtGui.QAction(MainWindow)
        self.action_path_select.setCheckable(True)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/pathtools/select"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_path_select.setIcon(icon7)
        self.action_path_select.setObjectName("action_path_select")
        self.action_path_create = QtGui.QAction(MainWindow)
        self.action_path_create.setCheckable(True)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/pathtools/force"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_path_create.setIcon(icon8)
        self.action_path_create.setObjectName("action_path_create")
        self.action_path_insertion = QtGui.QAction(MainWindow)
        self.action_path_insertion.setCheckable(True)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/pathtools/insert"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_path_insertion.setIcon(icon9)
        self.action_path_insertion.setObjectName("action_path_insertion")
        self.action_new_square_part = QtGui.QAction(MainWindow)
        self.action_new_square_part.setIcon(icon5)
        self.action_new_square_part.setObjectName("action_new_square_part")
        self.action_path_skip = QtGui.QAction(MainWindow)
        self.action_path_skip.setCheckable(True)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/pathtools/skip"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_path_skip.setIcon(icon10)
        self.action_path_skip.setObjectName("action_path_skip")
        self.action_path_paint = QtGui.QAction(MainWindow)
        self.action_path_paint.setCheckable(True)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/pathtools/paint"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_path_paint.setIcon(icon11)
        self.action_path_paint.setObjectName("action_path_paint")
        self.action_path_add_seq = QtGui.QAction(MainWindow)
        self.action_path_add_seq.setCheckable(True)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/pathtools/addseq"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_path_add_seq.setIcon(icon12)
        self.action_path_add_seq.setObjectName("action_path_add_seq")
        self.action_export_staples = QtGui.QAction(MainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/filetools/export"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.action_cadnano_website = QtGui.QAction(MainWindow)
        self.action_cadnano_website.setObjectName("action_cadnano_website")
        self.action_feedback = QtGui.QAction(MainWindow)
        self.action_feedback.setObjectName("action_feedback")
        self.action_filter_part = QtGui.QAction(MainWindow)
        self.action_filter_part.setCheckable(True)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/parttools/filter-part"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_filter_part.setIcon(icon14)
        self.action_filter_part.setObjectName("action_filter_part")
        self.action_filter_endpoint = QtGui.QAction(MainWindow)
        self.action_filter_endpoint.setCheckable(True)
        self.action_filter_endpoint.setChecked(True)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/parttools/filter-endpoint"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon15.addPixmap(QtGui.QPixmap(":/parttools/filter-endpoint-disabled"), QtGui.QIcon.Mode.Disabled, QtGui.QIcon.State.Off)
        self.action_filter_endpoint.setIcon(icon15)
        self.action_filter_endpoint.setObjectName("action_filter_endpoint")
        self.action_filter_xover = QtGui.QAction(MainWindow)
        self.action_filter_xover.setCheckable(True)
        self.action_filter_xover.setChecked(True)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/parttools/filter-xover"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon16.addPixmap(QtGui.QPixmap(":/parttools/filter-xover-disabled"), QtGui.QIcon.Mode.Disabled, QtGui.QIcon.State.Off)
        self.action_filter_xover.setIcon(icon16)
        self.action_filter_xover.setObjectName("action_filter_xover")
        self.action_views_label = QtGui.QAction(MainWindow)
        self.action_views_label.setEnabled(False)
        self.action_views_label.setObjectName("action_views_label")
        self.action_filter_strand = QtGui.QAction(MainWindow)
        self.action_filter_strand.setCheckable(True)
        self.action_filter_strand.setChecked(True)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/parttools/filter-strand"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon17.addPixmap(QtGui.QPixmap(":/parttools/filter-strand-disabled"), QtGui.QIcon.Mode.Disabled, QtGui.QIcon.State.Off)
        self.action_filter_strand.setIcon(icon17)
        self.action_filter_strand.setObjectName("action_filter_strand")
        self.action_filter_helix = QtGui.QAction(MainWindow)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/parttools/filter-handle"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon18.addPixmap(QtGui.QPixmap(":/parttools/filter-handle-alt"), QtGui.QIcon.Mode.Disabled, QtGui.QIcon.State.Off)
        self.action_filter_helix.setIcon(icon18)
        self.action_filter_helix.setObjectName("action_filter_helix")
        self.action_about = QtGui.QAction(MainWindow)
        self.action_about.setObjectName("action_about")
        self.action_path_mods = QtGui.QAction(MainWindow)
        self.action_path_mods.setCheckable(True)
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/pathtools/mod"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_path_mods.setIcon(icon19)
        self.action_path_mods.setObjectName("action_path_mods")
        self.action_new_dnapart_honeycomb = QtGui.QAction(MainWindow)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/parttools/new-honeycomb-disabled"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon20.addPixmap(QtGui.QPixmap(":/parttools/new-honeycomb"), QtGui.QIcon.Mode.Disabled, QtGui.QIcon.State.Off)
        ...
        self.action_new_dnapart_square = QtGui.QAction(MainWindow)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/parttools/new-square-disabled"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon21.addPixmap(QtGui.QPixmap(":/parttools/new-square"), QtGui.QIcon.Mode.Disabled, QtGui.QIcon.State.Off)
        ...
        self.action_inspector = QtGui.QAction(MainWindow)
        self.action_inspector.setCheckable(True)
        self.action_inspector.setChecked(True)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/parttools/outliner"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_inspector.setIcon(icon22)
        self.action_inspector.setObjectName("action_inspector")
        self.action_new_part = QtGui.QAction(MainWindow)
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/parttools/new-origami"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_new_part.setIcon(icon23)
        self.action_new_part.setObjectName("action_new_part")
        self.action_new_plasmidpart = QtGui.QAction(MainWindow)
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/parttools/new-dna"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_new_plasmidpart.setIcon(icon24)
        self.action_new_plasmidpart.setObjectName("action_new_plasmidpart")
        self.action_filter_pre_axover = QtGui.QAction(MainWindow)
        self.action_filter_pre_axover.setCheckable(True)
        self.action_filter_pre_axover.setChecked(True)
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/parttools/filter-pre-axover"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_filter_pre_axover.setIcon(icon25)
        self.action_filter_pre_axover.setObjectName("action_filter_pre_axover")
        self.action_filter_pre_pxover = QtGui.QAction(MainWindow)
        self.action_filter_pre_pxover.setCheckable(True)
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/parttools/filter-pre-pxover"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_filter_pre_pxover.setIcon(icon26)
        self.action_filter_pre_pxover.setObjectName("action_filter_pre_pxover")
        self.action_vhelix_create = QtGui.QAction(MainWindow)
        self.action_vhelix_create.setCheckable(True)
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/slicetools/create-helix"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_vhelix_create.setIcon(icon27)
        self.action_vhelix_create.setObjectName("action_vhelix_create")
        self.action_filter_fwd = QtGui.QAction(MainWindow)
        self.action_filter_fwd.setCheckable(True)
        self.action_filter_fwd.setChecked(True)
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/parttools/filter-fwd"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_filter_fwd.setIcon(icon28)
        self.action_filter_fwd.setObjectName("action_filter_fwd")
        self.action_filter_rev = QtGui.QAction(MainWindow)
        self.action_filter_rev.setCheckable(True)
        self.action_filter_rev.setChecked(True)
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/parttools/filter-rev"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_filter_rev.setIcon(icon29)
        self.action_filter_rev.setObjectName("action_filter_rev")
        self.action_vhelix_select = QtGui.QAction(MainWindow)
        self.action_vhelix_select.setCheckable(True)
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/slicetools/select-helix"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_vhelix_select.setIcon(icon30)
        self.action_vhelix_select.setObjectName("action_vhelix_select")
        self.action_vhelix_snap = QtGui.QAction(MainWindow)
        self.action_vhelix_snap.setCheckable(True)
        self.action_vhelix_snap.setChecked(True)
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/slicetools/snap-helix"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_vhelix_snap.setIcon(icon31)
        self.action_vhelix_snap.setObjectName("action_vhelix_snap")
        self.action_global_create = QtGui.QAction(MainWindow)
        self.action_global_create.setCheckable(True)
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/pathtools/create"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon32.addPixmap(QtGui.QPixmap(":/pathtools/create-disabled"), QtGui.QIcon.Mode.Disabled, QtGui.QIcon.State.Off)
        self.action_global_create.setIcon(icon32)
        self.action_global_create.setObjectName("action_global_create")
        self.action_global_select = QtGui.QAction(MainWindow)
        ...
        self.action_filters_label = QtGui.QAction(MainWindow)
        self.action_filters_label.setEnabled(False)
        self.action_filters_label.setObjectName("action_filters_label")
        self.action_toolbar_spacer_2 = QtGui.QAction(MainWindow)
        ...
        self.action_toolbar_spacer_21 = QtGui.QAction(MainWindow)
        ...
        self.action_slice = QtGui.QAction(MainWindow)
        self.action_slice.setCheckable(True)
        self.action_slice.setChecked(True)
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/parttools/slice"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_slice.setIcon(icon35)
        self.action_slice.setObjectName("action_slice")
        self.action_path = QtGui.QAction(MainWindow)
        self.action_path.setCheckable(True)
        self.action_path.setChecked(True)
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(":/parttools/path"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
