...
class Ui_Preferences(object):
    def setupUi(self, Preferences):
        ...
        self.form_layout.setFieldGrowthPolicy(QtWidgets.QFormLayout.FieldGrowthPolicy.FieldsStayAtSizeHint)
        ...
        self.form_layout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.enabled_sliceview_label)
        ...
        self.enabled_orthoview_combo_box.addItem("")
        self.form_layout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.enabled_orthoview_combo_box)
        self.Grid = QtWidgets.QLabel(Preferences)
        self.Grid.setObjectName("Grid")
        self.form_layout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.Grid)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/part/grid_points"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.gridview_style_combo_box.addItem(icon, "")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/part/grid_lines"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.gridview_style_combo_box.addItem(icon1, "")
        self.form_layout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.gridview_style_combo_box)
        self.zoom_speed_label = QtWidgets.QLabel(Preferences)
        self.zoom_speed_label.setObjectName("zoom_speed_label")
        self.form_layout.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.zoom_speed_label)
        ...
        self.zoom_speed_slider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.zoom_speed_slider.setInvertedControls(False)
        self.zoom_speed_slider.setTickPosition(QtWidgets.QSlider.TickPosition.TicksBelow)
        self.zoom_speed_slider.setTickInterval(0)
        self.zoom_speed_slider.setObjectName("zoom_speed_slider")
        self.form_layout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.zoom_speed_slider)
        self.show_icon_label_text = QtWidgets.QLabel(Preferences)
        self.show_icon_label_text.setObjectName("show_icon_label_text")
        self.form_layout.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.show_icon_label_text)
        ...
        self.form_layout.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.show_icon_labels)
        self.verticalLayout.addLayout(self.form_layout)
        self.button_box = QtWidgets.QDialogButtonBox(Preferences)
        self.button_box.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.RestoreDefaults)
