...
class Ui_ModsDialog(object):
    def setupUi(self, ModsDialog):
        ...
        self.custom_button_box.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Apply | QtWidgets.QDialogButtonBox.StandardButton.Cancel)
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.nameLabel)
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.nameComboBox)
        self.colorLabel = QtWidgets.QLabel(ModsDialog)
        self.colorLabel.setObjectName("colorLabel")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.colorLabel)
        self.colorLineEdit = QtWidgets.QLineEdit(ModsDialog)
        self.colorLineEdit.setObjectName("colorLineEdit")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.colorLineEdit)
        self.sequence5Label = QtWidgets.QLabel(ModsDialog)
        self.sequence5Label.setObjectName("sequence5Label")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.sequence5Label)
        self.sequence5LineEdit = QtWidgets.QLineEdit(ModsDialog)
        self.sequence5LineEdit.setObjectName("sequence5LineEdit")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.sequence5LineEdit)
        self.sequence3Label = QtWidgets.QLabel(ModsDialog)
        self.sequence3Label.setObjectName("sequence3Label")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.sequence3Label)
        self.sequence3LineEdit = QtWidgets.QLineEdit(ModsDialog)
        self.sequence3LineEdit.setObjectName("sequence3LineEdit")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.sequence3LineEdit)
        self.sequenceInternalLabel = QtWidgets.QLabel(ModsDialog)
        self.sequenceInternalLabel.setObjectName("sequenceInternalLabel")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.sequenceInternalLabel)
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.sequenceInternalLineEdit)
        self.noteLabel = QtWidgets.QLabel(ModsDialog)
        self.noteLabel.setObjectName("noteLabel")
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.ItemRole.LabelRole, self.noteLabel)
        self.noteTextEdit = QtWidgets.QTextEdit(ModsDialog)
        self.noteTextEdit.setObjectName("noteTextEdit")
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.noteTextEdit)
