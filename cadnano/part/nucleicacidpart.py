...
from cadnano.proxies.cnenum import GridType, PartType, PointType, StrandType
...
class NucleicAcidPart(Part):
    ...
    def getCircularOligos(self, include_scaffold=True):
        """
        ...
        for o in list(self.oligos()):
            if o.isCircular():
                if not include_scaffold and o.strand5p().strandType() != StrandType.SCAFFOLD:
                    circ_olgs.append(o)
                else:
                    circ_olgs.append(o)
        return circ_olgs
